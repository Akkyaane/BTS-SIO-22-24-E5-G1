...
<body>
    ...
    <main>
        <div class="container mt-5">
            ...
            <form action="../../../models/expenseSheet/updateExpenseSheet.php?updateid=<?php echo $id;?>" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <input type="number" class="form-control" name="nights_number" placeholder="Nombre de nuitées" value="<?php echo $data['nights_number']; ?>" required>
                </div>
                <div class="mb-3">
                    <label for="date">Date de la demande de soumission :</label>
                    <input type="date" class="form-control" name="request_date" value="<?php echo $data['request_date']; ?>" required>
                </div>
                <div class="mb-3">
                    <h3>Frais</h3>
                </div>
                ...
                <div class="mb-3">
                    <input type="number" step=0.01 class="form-control form-control-v2" id="kilometers_expense" name="kilometers_expense" placeholder="Nombre total de kilomètres" value="<?php echo $data['kilometers_expense']; ?>">
                </div>
                <div class="mb-3">
                    <input type="number" step=0.01 class="form-control form-control-v2" id="transport_expense" name="transport_expense" placeholder="Montant total en euros" value="<?php echo $data['transport_expense']; ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <h5>Hébergement</h5>
                    <input type="number" step=0.01 class="form-control" name="accommodation_expense" placeholder="Montant total en euros" value="<?php echo $data['accommodation_expense']; ?>" >
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <h5>Alimentation</h5>
                    <input type="number" step=0.01 class="form-control" name="food_expense" placeholder="Montant total en euros" value="<?php echo $data['food_expense']; ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <h5>Autres</h5>
                    <input type="number" step=0.01 class="form-control" name="other_expense" placeholder="Montant total en euros" value="<?php echo $data['other_expense']; ?>">
                </div>
                <div class="mb-3">
                    <input type="file" class="form-control" name="other_expense_file">
                </div>
                <div class="mb-3">
                    <textarea class="form-control" rows="3" name="message" id="message" placeholder="Écrire un message..." maxlength="500" value="<?php echo $data['message']; ?>"></textarea><div id="charCount">0/500</div>
                </div>
                <div class="mb-3">
