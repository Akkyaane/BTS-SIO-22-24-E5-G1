...
<body>
    ...
    <main>
        <div class="container mt-5">
            <form>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="transport_category" id="transport_category" onchange="showDiv(this)" readonly>
                        ...
                        <option value="1"<?php if ($data['transport_category'] == '1') echo ' selected'; ?> disabled>Avion</option>
                        <option value="2"<?php if ($data['transport_category'] == '2') echo ' selected'; ?> disabled>Bus</option>
                        <option value="3"<?php if ($data['transport_category'] == '3') echo ' selected'; ?> disabled>Car</option>
                        <option value="4"<?php if ($data['transport_category'] == '4') echo ' selected'; ?> disabled>Taxi</option>
                        <option value="5"<?php if ($data['transport_category'] == '5') echo ' selected'; ?> disabled>Train</option>
                        <option value="6"<?php if ($data['transport_category'] == '6') echo ' selected'; ?> disabled>Voiture</option>
                    </select>
                </div>
                <div class="mb-3">
            ...
            <div class="mb-3">
                <button class="btn btn-primary"><a href="../home/visitorHome.php" style="color: white">Retour</a></button>
            </div>
        </div>
    </main>
