            ...
            <form>
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="start_date" id="start_date"
                        value="<?php echo $data['start_date']; ?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="date">Date de retour :</label>
                    <input type="date" class="form-control" name="end_date" id="end_date"
                        value="<?php echo $data['end_date']; ?>" readonly>
                </div>
                <div class="mb-3">
                    <input type="number" class="form-control" name="nights_number" id="nights_number"
                        placeholder="Nombre de nuitées" value="<?php echo $data['nights_number']; ?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="date">Demande effectuée le :</label>
                    <input type="date" class="form-control" name="request_date" id="request_date"
                        value="<?php echo $data['request_date']; ?>" readonly>
                </div>
                <div class="mb-3">
                    <h3>Frais</h3>
                    <h5>Transport</h5>
                    <select class="form-select" name="transport_category" id="transport_category"
                        onchange="showDiv(this)" readonly>
                        <option hidden selected>Sélectionnez le type de transport</option>
                        <option value="1" <?php if ($data['transport_category'] == '1') ?>>Avion</option>
                        <option value="2" <?php if ($data['transport_category'] == '2') ?>>Train
                        </option>
                        <option value="3" <?php if ($data['transport_category'] == '3') ?>>Bus/ Car/ Taxi
                        </option>
                        <option value="4" <?php if ($data['transport_category'] == '4') ?>>Voiture
                        </option>
                    </select>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step=0.01 class="form-control" name="accommodation_expense"
                        ...
                        value="<?php echo $data['accommodation_expense']; ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step=0.01 class="form-control" name="food_expense" id="food_expense"
                        placeholder="Montant total en euros" value="<?php echo $data['food_expense']; ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step=0.01 class="form-control" name="other_expense" id="other_expense"
                        placeholder="Montant total en euros" value="<?php echo $data['other_expense']; ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <textarea class="form-control" rows="3" name="message" id="message"
                        placeholder="Écrire un message..." maxlength="500" value="<?php echo $data['message']; ?>"
                        readonly></textarea>
